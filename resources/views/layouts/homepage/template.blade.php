...
<head>
    ...
    <style>
        ...
        .ve-newsletter-section .ve-newsletter-wrap {
            ...
            padding: 60px 48px;
            border-radius: 30px;
            background: linear-gradient(135deg, var(--brand-p) 0%, #C2186D 100%);
            box-shadow: 0 20px 50px rgba(236, 30, 136, 0.2);
            color: #fff;
        }
        ...
        .faq-marquee-container:hover .faq-marquee-inner {
            animation-play-state: paused;
        }
        ...
        .btn-p:hover {
            ...
            background: #C2186D;
            box-shadow: 0 20px 45px rgba(236, 30, 136, 0.35);
        }
        ...
        .faskes-card-light:hover {
            ...
            box-shadow: 0 30px 60px rgba(22, 179, 172, 0.1);
        }
        ...
        .faq-v2-item:hover {
            border-color: rgba(236, 30, 136, 0.2);
            background: #fff;
        }
        ...
        .service-mini-card:hover {
            border-color: var(--brand-p);
            box-shadow: 0 30px 60px rgba(236, 30, 136, 0.05);
        ...
        @media (max-width: 768px) {
            ...
            .mockup-wrap .badge-pill {
                margin: 0 auto 15px auto;
            }

            .mockup-wrap .d-flex.mb-4,
            .mockup-wrap .d-flex.mb-5 {
                justify-content: center;
                text-align: left;
                max-width: 100%;
                margin: 0 auto;
            ...
            .konsultasi-online .d-flex.gap-4 {
                flex-direction: column;
                align-items: center;
                gap: 16px !important;
            }

            .konsultasi-online .col-lg-5 {
                margin-top: 40px;
            }
    ...
    <header class="ve-header" id="ve-sticky">
            ...
            <div class="ve-logo">
                <a href="{{ route('homepage') }}" class="d-flex align-items-center">
                    ...
                    <div class="ve-logo-text">
                        <span style="font-size: 1.2rem; font-weight: 700; color: #EC1E88;"><strong
                                style="color: var(--primary-color);">MYKIA</strong></span>
                    </div>
                </a>
            </div>
            ...
            <nav class="ve-nav">
                <ul>
                    <li><a href="{{ route('homepage') }}"
                            class="{{ request()->routeIs('homepage') ? 'active' : '' }}">Beranda</a></li>
                    <li class="has-drop">
                        <a href="{{ route('homepage.about') }}"
                            class="{{ request()->routeIs('homepage.about') || request()->routeIs('homepage.visimisi') ? 'active' : '' }}">Tentang
                            <i class="fa fa-angle-down"></i></a>
                        <ul class="ve-dropdown">
                            <li><a href="{{ route('homepage.about') }}">Tentang Kami</a></li>
                            <li><a href="{{ route('homepage.visimisi') }}">Visi & Misi</a></li>
                        </ul>
                    </li>
                    <li><a href="{{ route('homepage.layanan') }}"
                            class="{{ request()->routeIs('homepage.layanan') ? 'active' : '' }}">Layanan</a></li>
                    {{-- <li class="has-drop">
                        <a href="#">Buku KIA <i class="fa fa-angle-down"></i></a>
                        <ul class="ve-dropdown ve-dropdown-rich">
                            <li>
                                <a href="{{ route('homepage') }}#program-kehamilan">
                                    <div class="ve-dropdown-rich-icon" style="background: rgba(236, 30, 136, 0.08); color: #EC1E88;">
                                        <i class="fa fa-heartbeat"></i>
                                    </div>
                                    <div style="text-align: left;">
                                        <span class="d-block sora fw-bold" style="font-size: 0.9rem; color: var(--ve-dark); margin-bottom: 2px; line-height: 1.2;">Kehamilan Sehat</span>
                                        <span class="d-block text-muted" style="font-size: 0.75rem; line-height: 1.3;">Panduan gizi & perkembangan janin</span>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('homepage') }}#program-imunisasi">
                                    <div class="ve-dropdown-rich-icon" style="background: rgba(22, 179, 172, 0.08); color: #16B3AC;">
                                        <i class="fa fa-shield"></i>
                                    </div>
                                    <div style="text-align: left;">
                                        <span class="d-block sora fw-bold" style="font-size: 0.9rem; color: var(--ve-dark); margin-bottom: 2px; line-height: 1.2;">Imunisasi Rutin</span>
                                        <span class="d-block text-muted" style="font-size: 0.75rem; line-height: 1.3;">Jadwal lengkap & catatan vaksinasi</span>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('homepage') }}#program-gizi">
                                    <div class="ve-dropdown-rich-icon" style="background: rgba(249, 115, 22, 0.08); color: #F97316;">
                                        <i class="fa fa-apple"></i>
                                    </div>
                                    <div style="text-align: left;">
                                        <span class="d-block sora fw-bold" style="font-size: 0.9rem; color: var(--ve-dark); margin-bottom: 2px; line-height: 1.2;">Nutrisi & Gizi</span>
                                        <span class="d-block text-muted" style="font-size: 0.75rem; line-height: 1.3;">Resep MPASI & nutrisi seimbang</span>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('homepage') }}#program-tumbuh">
                                    <div class="ve-dropdown-rich-icon" style="background: rgba(168, 85, 247, 0.08); color: #A855F7;">
                                        <i class="fa fa-child"></i>
                                    </div>
                                    <div style="text-align: left;">
                                        <span class="d-block sora fw-bold" style="font-size: 0.9rem; color: var(--ve-dark); margin-bottom: 2px; line-height: 1.2;">Tumbuh Kembang</span>
                                        <span class="d-block text-muted" style="font-size: 0.75rem; line-height: 1.3;">Pantau tumbuh kembang & kurva KMS</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
                    </li> --}}
                    <li><a href="{{ route('homepage.artikel') }}"
                            class="{{ request()->routeIs('homepage.artikel') ? 'active' : '' }}">Artikel</a></li>
                    <li><a href="{{ route('homepage.contact') }}"
                            class="{{ request()->routeIs('homepage.contact') ? 'active' : '' }}">Kontak</a></li>
                </ul>
            </nav>
        ...
        <div class="ve-mobile-menu" id="ve-mobile-menu">
            <ul>
                ...
                <li><a href="{{ route('homepage') }}#program-kehamilan">Buku KIA</a></li>
