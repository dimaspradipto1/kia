            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="d-inline-flex shadow-sm overflow-hidden" style="border: 1px solid #e3e6f0; border-radius: 30px;">
                        <a href="{{ route('abouts.create') }}" class="btn btn-success btn-sm font-weight-bold px-3 py-1 border-0"
                            ...
                            <i class="bi bi-plus-lg me-1"></i> TAMBAH KONTEN ABOUT
                        </a>
                    </div>
                </div>
                <div class="col-md-4 text-end">
                    <h5 class="m-0 fw-bold text-dark" style="font-size: 1.1rem;">Manajemen About</h5>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).on('click', '.btn-delete', function (e) {
            ...
            Swal.fire({
                ...
                text: "Data about beserta semua gambarnya akan dihapus permanen!",
                icon: 'warning',
