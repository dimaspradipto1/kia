                ...
                <div class="col-lg-5 mb-4">
                    <div class="card border-0 shadow-sm mb-4" style="border-radius:12px; border-top:5px solid #0d6efd !important;">
                        <div class="card-header bg-white border-bottom py-3 px-4">
                            <h5 class="m-0 fw-bold text-dark"><i class="bi bi-person-badge text-primary me-1"></i> Identitas Bayi & Petugas</h5>
                        </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="kondisi_umum" class="form-select @error('kondisi_umum') is-invalid @enderror" required>
                                    ...
                                    @foreach (['Baik', 'Sedang', 'Buruk'] as $k)
                                        <option value="{{ $k }}" {{ old('kondisi_umum') == $k ? 'selected' : '' }}>{{ $k }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row align-items-end mb-3">
                                <div class="col-md-5">
                                    ...
                                    <select name="hb0_diberikan" id="hb0_diberikan" class="form-select @error('hb0_diberikan') is-invalid @enderror" required>
                                        <option value="1" {{ old('hb0_diberikan') == '1' ? 'selected' : '' }}>Diberikan</option>
                                        <option value="0" {{ old('hb0_diberikan') == '0' ? 'selected' : '' }}>Tidak Diberikan</option>
                                    </select>
                                ...
                                <div class="col-md-7" id="hb0_waktu_wrapper">
                                    ...
                                    <input type="time" name="hb0_waktu" class="form-control @error('hb0_waktu') is-invalid @enderror" value="{{ old('hb0_waktu') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="vit_k1_diberikan" class="form-select @error('vit_k1_diberikan') is-invalid @enderror" required>
                                    <option value="1" {{ old('vit_k1_diberikan') == '1' ? 'selected' : '' }}>Diberikan</option>
                                    <option value="0" {{ old('vit_k1_diberikan') == '0' ? 'selected' : '' }}>Tidak Diberikan</option>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="salep_mata_diberikan" class="form-select @error('salep_mata_diberikan') is-invalid @enderror" required>
                                    <option value="1" {{ old('salep_mata_diberikan') == '1' ? 'selected' : '' }}>Diberikan</option>
                                    <option value="0" {{ old('salep_mata_diberikan') == '0' ? 'selected' : '' }}>Tidak Diberikan</option>
                                </select>
                    ...
                    <div class="card border-0 shadow-sm mb-4" style="border-radius:12px; border-top:5px solid #EC1E88 !important;">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row align-items-end mb-3">
                                <div class="col-md-5">
                                    ...
                                    <select name="shk_dilakukan" id="shk_dilakukan" class="form-select @error('shk_dilakukan') is-invalid @enderror" required>
                                        <option value="0" {{ old('shk_dilakukan') == '0' ? 'selected' : '' }}>Tidak</option>
                                        <option value="1" {{ old('shk_dilakukan') == '1' ? 'selected' : '' }}>Ya</option>
                                    </select>
                                ...
                                <div class="col-md-7" id="shk_fields_wrapper" style="display:none;">
                                    ...
                                    <input type="time" name="shk_waktu" class="form-control @error('shk_waktu') is-invalid @enderror" value="{{ old('shk_waktu') }}">
                            ...
                            <div id="shk_hasil_wrapper" style="display:none;" class="mb-3">
                                ...
                                <input type="text" name="shk_hasil" class="form-control @error('shk_hasil') is-invalid @enderror" value="{{ old('shk_hasil') }}" placeholder="Contoh: Normal / Reaktif">
                            ...
                            <div class="row align-items-end mb-3">
                                <div class="col-md-5">
                                    ...
                                    <select name="pjb_dilakukan" id="pjb_dilakukan" class="form-select @error('pjb_dilakukan') is-invalid @enderror" required>
                                        <option value="0" {{ old('pjb_dilakukan') == '0' ? 'selected' : '' }}>Tidak</option>
                                        <option value="1" {{ old('pjb_dilakukan') == '1' ? 'selected' : '' }}>Ya</option>
                                    </select>
                                ...
                                <div class="col-md-7" id="pjb_hasil_wrapper" style="display:none;">
                                    ...
                                    <input type="text" name="pjb_hasil" class="form-control @error('pjb_hasil') is-invalid @enderror" value="{{ old('pjb_hasil') }}" placeholder="Contoh: Normal / Kelainan">
