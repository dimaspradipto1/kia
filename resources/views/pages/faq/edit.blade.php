        ...
        <div class="col-lg-12">
            <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px; overflow: hidden; border-top: 5px solid #EC1E88 !important;">
                <div class="card-header bg-white border-bottom py-3 px-4">
                    <h5 class="m-0 fw-bold text-dark" style="font-size: 1.1rem;">Form Edit FAQ</h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('faqs.update', $faq->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="jawaban" class="form-control @error('jawaban') is-invalid @enderror" rows="5" required>{{ old('jawaban', $faq->jawaban) }}</textarea>
                                @error('jawaban')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="tips" class="form-control @error('tips') is-invalid @enderror" rows="3">{{ old('tips', $faq->tips) }}</textarea>
                                @error('tips')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-10 offset-sm-2">
                                <button type="submit" class="btn text-white px-4" style="background-color: #EC1E88;">Perbarui FAQ</button>
