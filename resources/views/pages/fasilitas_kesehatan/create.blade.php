                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('fasilitas-kesehatan.store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    {{-- Hidden inputs that hold the actual values --}}
                                    ...
                                    <div class="d-flex gap-2 align-items-center mb-2 flex-wrap">
                                        <span class="badge bg-light text-dark border fw-semibold" style="font-size:0.8rem;">
                                            Lat: <span id="lat_display">{{ old('latitude', '-') }}</span>
                                        </span>
                                        <span class="badge bg-light text-dark border fw-semibold" style="font-size:0.8rem;">
                                            Lng: <span id="lng_display">{{ old('longitude', '-') }}</span>
                                        </span>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // ── Leaflet Map Picker ─────────────────────────────────────────────
    const DEFAULT_LAT = 1.1301, DEFAULT_LNG = 104.0529; // Batam
