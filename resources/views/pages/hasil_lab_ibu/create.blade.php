...
@section('content')
    <div class="pagetitle">
        <h1>Catat Hasil Laboratorium Ibu</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <section class="section animate__animated animate__fadeIn">
        <form action="{{ route('hasil-lab-ibu.store') }}" method="POST">
            @csrf
                    ...
                    <div class="card border-0 shadow-sm" style="border-radius:12px; border-top:5px solid #16B3AC !important; height: 100%;">
                        ...
                        <div class="card-body p-4">
                            <div class="mb-4">
                                ...
                                <select name="kunjungan_anc_id" class="form-select select2 @error('kunjungan_anc_id') is-invalid @enderror" data-placeholder="Pilih Kunjungan ANC" required>
                                    ...
                                    @foreach ($kunjunganAncs as $kanc)
                                        ...
                                        @endphp
                                        <option value="{{ $kanc->id }}" {{ old('kunjungan_anc_id', $selectedKunjunganId) == $kanc->id ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tanggal_periksa" class="form-control datepicker @error('tanggal_periksa') is-invalid @enderror" value="{{ old('tanggal_periksa', date('Y-m-d')) }}" placeholder="Pilih Tanggal Pemeriksaan" required>
                        ...
                        <div class="card-body p-4">
                            <div class="mb-3">
                                ...
                                <select id="pilih_jenis" class="form-select" required>
                                    ...
                                    <option value="Hemoglobin (Hb)">Hemoglobin (Hb) - Cegah Anemia</option>
                                    <option value="Protein Urine">Protein Urine - Deteksi Dini Preeklamsia</option>
                                    <option value="Gula Darah Sewaktu (GDS)">Gula Darah Sewaktu (GDS) - Cegah Diabetes Gestasional</option>
                                    <option value="Golongan Darah & Rhesus">Golongan Darah & Rhesus</option>
                                    <option value="Sifilis (Syphilis)">Tes Sifilis (Syphilis / VDRL)</option>
                                    <option value="HIV (Rapid Test)">Tes HIV</option>
                                    <option value="Hepatitis B (HBsAg)">Hepatitis B (HBsAg)</option>
                                    <option value="Lainnya">-- Tulis Parameter Kustom Lainnya --</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3" id="kustom_jenis_wrapper" style="display:none;">
                                ...
                                <input type="text" id="kustom_jenis" class="form-control" placeholder="Contoh: Eritrosit, Trombosit, Leukosit, dll.">
                            </div>

                            {{-- Hidden input yang dikirim ke backend --}}
                            <input type="hidden" name="jenis_pemeriksaan" id="jenis_pemeriksaan" value="{{ old('jenis_pemeriksaan') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="hasil" id="hasil" class="form-control @error('hasil') is-invalid @enderror" value="{{ old('hasil') }}" placeholder="Contoh: 11.5 atau Negatif" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="satuan" id="satuan" class="form-control @error('satuan') is-invalid @enderror" value="{{ old('satuan') }}" placeholder="Contoh: g/dl atau mg/dl" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nilai_normal" id="nilai_normal" class="form-control @error('nilai_normal') is-invalid @enderror" value="{{ old('nilai_normal') }}" placeholder="Contoh: >= 11.0 atau Negatif" required>
