...
@section('content')
                    ...
                    <div class="card-body p-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-5 col-lg-6 d-flex align-items-center gap-3 mb-3 mb-lg-0">
                                ...
                                <div>
                                    <h4 class="fw-bold text-dark mb-1">Imunisasi Anak</h4>
                                    <p class="text-muted small mb-0">Catat pemberian vaksin dan imunisasi sesuai jadwal program nasional.</p>
                                </div>
                            </div>
                                    ...
                                    <div class="col-6">
                                        <div class="d-flex align-items-center p-2 rounded h-100" style="background:rgba(22,163,74,.08);">
                                            ...
                                            <div>
                                                ...
                                                <div class="fw-bold fs-6 text-success mt-0.5">{{ \App\Models\ImunisasiAnak::count() }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="d-flex align-items-center p-2 rounded h-100" style="background:rgba(22,163,74,.08);">
                                            ...
                                            <div>
                                                ...
                                                <div class="fw-bold fs-6 text-success mt-0.5">{{ \App\Models\ImunisasiAnak::whereMonth('tanggal_pemberian', now()->month)->whereYear('tanggal_pemberian', now()->year)->count() }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-2 col-lg-12 text-xl-end mt-3 mt-xl-0">
                                <a href="{{ route('imunisasi-anak.create') }}" class="btn text-white py-2.5 px-3 shadow-sm fw-bold w-100"
                ...
                <div class="card border-0 shadow-sm" style="border-radius:12px;">
                    ...
                    <div class="card-body p-4">
                        <div class="table-responsive">
                            {{ $dataTable->table(['class' => 'table table-hover table-bordered align-middle table-custom-imunisasi', 'style' => 'width:100%']) }}
                        </div>
                    </div>
                </div>
            </div>
    ...
    <style>
        .table-custom-imunisasi.table-bordered,
        .table-custom-imunisasi.table-bordered th,
        .table-custom-imunisasi.table-bordered td {
