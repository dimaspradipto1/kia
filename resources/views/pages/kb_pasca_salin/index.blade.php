            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="d-inline-flex shadow-sm overflow-hidden"
                        ...
                        <a href="{{ route('kb-pasca-salin.create') }}"
                            class="btn btn-sm font-weight-bold px-3 py-1 border-0 text-white"
                            style="background-color: #EC1E88; font-size: 11px; height: 32px; display: flex; align-items: center; border-radius: 30px;">
                            <i class="bi bi-plus-lg me-1"></i> TAMBAH KB PASCA SALIN
                        </a>
                    </div>
                </div>
                <div class="col-md-4 text-end">
                    <h5 class="m-0 fw-bold text-dark" style="font-size: 1.1rem;">Data KB Pasca Salin</h5>
                </div>
            </div>
        </div>
