...
@section('content')
    ...
    <section class="section animate__animated animate__fadeIn">
        <form action="{{ route('kunjungan-anc.store') }}" method="POST">
            @csrf
                ...
                <div class="col-lg-5 mb-4">
                    <div class="card border-0 shadow-sm mb-4" style="border-radius:12px; border-top:5px solid #EC1E88 !important; height: 100%;">
                        <div class="card-header bg-white border-bottom py-3 px-4">
                            <h5 class="m-0 fw-bold text-dark"><i class="bi bi-calendar-check text-pink me-1"></i> Data Kunjungan</h5>
                        </div>
                        <div class="card-body p-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="trimester" class="form-select @error('trimester') is-invalid @enderror" required>
                                        ...
                                        @foreach ([1 => 'Trimester I', 2 => 'Trimester II', 3 => 'Trimester III'] as $tVal => $tLabel)
                                            <option value="{{ $tVal }}" {{ old('trimester') == $tVal ? 'selected' : '' }}>{{ $tLabel }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="kunjungan_ke" class="form-control @error('kunjungan_ke') is-invalid @enderror" value="{{ old('kunjungan_ke', 1) }}" min="1" max="10" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tanggal_kunjungan" class="form-control datepicker @error('tanggal_kunjungan') is-invalid @enderror" value="{{ old('tanggal_kunjungan', date('Y-m-d')) }}" placeholder="Pilih Tanggal" required>
                        ...
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.1" name="berat_badan" class="form-control @error('berat_badan') is-invalid @enderror" value="{{ old('berat_badan') }}" placeholder="Contoh: 55.4" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.1" name="lila_cm" class="form-control @error('lila_cm') is-invalid @enderror" value="{{ old('lila_cm') }}" placeholder="Contoh: 24.5" required>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="tekanan_darah_sistolik" class="form-control @error('tekanan_darah_sistolik') is-invalid @enderror" value="{{ old('tekanan_darah_sistolik', 120) }}" placeholder="Sistolik" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="tekanan_darah_diastolik" class="form-control @error('tekanan_darah_diastolik') is-invalid @enderror" value="{{ old('tekanan_darah_diastolik', 80) }}" placeholder="Diastolik" required>
                                        <span class="input-group-text bg-light text-muted">mmHg</span>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.1" name="tinggi_fundus_cm" class="form-control @error('tinggi_fundus_cm') is-invalid @enderror" value="{{ old('tinggi_fundus_cm') }}" placeholder="Kosongkan jika belum teraba">
                                        <span class="input-group-text bg-light text-muted">cm</span>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="status_tt" class="form-select @error('status_tt') is-invalid @enderror">
                                        ...
                                        @foreach (['T1', 'T2', 'T3', 'T4', 'T5'] as $tt)
                                            <option value="{{ $tt }}" {{ old('status_tt') == $tt ? 'selected' : '' }}>{{ $tt }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row border-top pt-3 mt-3 border-light">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="denyut_jantung_janin" class="form-control @error('denyut_jantung_janin') is-invalid @enderror" value="{{ old('denyut_jantung_janin') }}" placeholder="Contoh: 140 / Negatif">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="letak_janin" class="form-select @error('letak_janin') is-invalid @enderror">
                                        ...
                                        @foreach (['Kepala Bawah (Presentasi Kepala)', 'Sungsang / Bokong', 'Lintang', 'Belum Teraba'] as $letak)
                                            <option value="{{ $letak }}" {{ old('letak_janin') == $letak ? 'selected' : '' }}>{{ $letak }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="usg_dilakukan" id="usg_dilakukan" class="form-select @error('usg_dilakukan') is-invalid @enderror" required>
                                        <option value="Tidak" {{ old('usg_dilakukan') == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                                        <option value="Ya" {{ old('usg_dilakukan') == 'Ya' ? 'selected' : '' }}>Ya</option>
                                    </select>
                                ...
                                <div class="col-md-6 mb-3" id="hasil_usg_wrapper" style="display: none;">
                                    ...
                                    <input type="text" name="hasil_usg" class="form-control @error('hasil_usg') is-invalid @enderror" value="{{ old('hasil_usg') }}" placeholder="Contoh: Normal / Sesuai Usia Kehamilan">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select name="skrining_jiwa" class="form-select @error('skrining_jiwa') is-invalid @enderror">
                                        <option value="Sehat / Normal" {{ old('skrining_jiwa') == 'Sehat / Normal' ? 'selected' : '' }}>Sehat / Normal</option>
                                        <option value="Berisiko Depresi" {{ old('skrining_jiwa') == 'Berisiko Depresi' ? 'selected' : '' }}>Berisiko Depresi / Gangguan Kecemasan</option>
                                    </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" rows="3" placeholder="Rekomendasi diet, suplemen TTD, rencana persalinan, dll.">{{ old('catatan') }}</textarea>
                            ...
                            <div class="row mt-4">
                                <div class="col-12 text-end">
                                    ...
                                    <button type="submit" class="btn text-white px-5 shadow-sm" style="background-color:#EC1E88; border-radius:30px; font-weight: 600;">
                                        <i class="bi bi-save me-1"></i> Simpan ANC
                                    </button>
                                </div>
                            </div>
                        </div>
