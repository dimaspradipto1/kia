            ...
            <div class="col-lg-12">
                <div class="card border-0 shadow-sm mb-4" style="border-radius:12px; border-top:5px solid #EC1E88 !important;">
                    <div class="card-header bg-white border-bottom py-3 px-4">
                        <h5 class="m-0 fw-bold text-dark">Form Tambah Pembiayaan</h5>
                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="tanggal_berlaku"
                                           ...
                                           value="{{ old('tanggal_berlaku') }}" placeholder="Pilih Tanggal">
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                // Dynamic label & placeholder for nama_asuransi
