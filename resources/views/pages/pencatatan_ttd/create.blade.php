...
@section('content')
    ...
    <section class="section animate__animated animate__fadeIn">
        <form action="{{ route('pencatatan-ttd.store') }}" method="POST">
            @csrf
                ...
                <div class="col-lg-8">
                    <div class="card border-0 shadow-sm mb-4" style="border-radius:12px; border-top:5px solid #e11d48 !important;">
                        <div class="card-header bg-white border-bottom py-3 px-4">
                            <h5 class="m-0 fw-bold text-dark"><i class="bi bi-droplet-fill text-danger me-1"></i> Data Pemberian Tablet Tambah Darah</h5>
                        </div>
                        <div class="card-body p-4">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="d-flex gap-4 mt-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="diminum" id="diminum_ya" value="Ya" {{ old('diminum', 'Ya') == 'Ya' ? 'checked' : '' }} required>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="diminum" id="diminum_tidak" value="Tidak" {{ old('diminum') == 'Tidak' ? 'checked' : '' }} required>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" rows="4" placeholder="Keterangan dosis, reaksi obat, atau catatan penting lainnya...">{{ old('catatan') }}</textarea>
