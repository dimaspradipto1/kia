            ...
            <div class="col-lg-12">
                <div class="card border-0 shadow-sm mb-4"
                    ...
                    <div class="card-header bg-white border-bottom py-3 px-4">
                        <h5 class="m-0 fw-bold text-dark" style="font-size: 1.1rem;">Form Edit Profil Ibu</h5>
                    </div>
                    <div class="card-body p-4">
                        <form action="{{ route('profil-ibu.update', $profilIbu->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row mb-4">
                                <input type="hidden" name="user_id" value="{{ old('user_id', $profilIbu->user_id) }}">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select name="fasilitas_kesehatan_id"
                                        ...
                                        @foreach ($faskes as $f)
                                            <option value="{{ $f->id }}"
                                                {{ old('fasilitas_kesehatan_id', $profilIbu->fasilitas_kesehatan_id) == $f->id ? 'selected' : '' }}>
...
@endpush
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="golongan_darah" class="form-select">
                                        ...
                                        <option value="A" {{ old('golongan_darah', $profilIbu->golongan_darah) == 'A' ? 'selected' : '' }}>A</option>
                                        <option value="B" {{ old('golongan_darah', $profilIbu->golongan_darah) == 'B' ? 'selected' : '' }}>B</option>
                                        <option value="AB" {{ old('golongan_darah', $profilIbu->golongan_darah) == 'AB' ? 'selected' : '' }}>AB</option>
                                        <option value="O" {{ old('golongan_darah', $profilIbu->golongan_darah) == 'O' ? 'selected' : '' }}>O</option>
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="pendidikan" class="form-select">
                                        ...
                                        @foreach(['Tidak Sekolah', 'SD', 'SMP', 'SMA', 'D3', 'S1', 'S2', 'S3'] as $p)
                                            <option value="{{ $p }}" {{ old('pendidikan', $profilIbu->pendidikan) == $p ? 'selected' : '' }}>{{ $p }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="pekerjaan" class="form-control"
                                        value="{{ old('pekerjaan', $profilIbu->pekerjaan) }}">
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="agama" class="form-select">
                                        ...
                                        @foreach(['Islam', 'Kristen', 'Katolik', 'Hindu', 'Budha', 'Khonghucu'] as $a)
                                            <option value="{{ $a }}" {{ old('agama', $profilIbu->agama) == $a ? 'selected' : '' }}>{{ $a }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="alamat" class="form-control" rows="3">{{ old('alamat', $profilIbu->alamat) }}</textarea>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <button type="submit" class="btn text-white px-4"
                                        style="background-color: #EC1E88; border-radius: 8px;">Perbarui Profil</button>
