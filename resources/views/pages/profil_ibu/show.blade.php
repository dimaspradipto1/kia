        ...
        <div class="col-xl-4">
            <div class="card shadow-sm border-0" style="border-radius: 12px; border-top: 5px solid #EC1E88 !important;">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    <img src="{{ asset('assets/img/default-profile.png') }}" alt="Profile" class="rounded-circle mb-3" style="width: 120px; border: 4px solid #f8f9fa;">
                    <h2 class="fw-bold text-center">{{ $profilIbu->nama_lengkap }}</h2>
                    <h3 class="text-muted small">NIK: {{ $profilIbu->nik }}</h3>
