            ...
            <div class="col-lg-12">
                <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px; border-top: 5px solid #EC1E88 !important;">
                    <div class="card-header bg-white border-bottom py-3 px-4">
                        <h5 class="m-0 fw-bold text-dark">Form Tambah Profil Suami</h5>
                    </div>
                    <div class="card-body p-4">
                        <form action="{{ route('profil-suami.store') }}" method="POST">
                            @csrf
                            <div class="row mb-4">
                                <div class="col-md-12">
                                    <label class="form-label fw-bold">Pilih Istri (Profil Ibu)</label>
                                    <select name="profil_ibu_id" class="form-select select2 @error('profil_ibu_id') is-invalid @enderror" data-placeholder="Pilih Istri" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="nomor_wa" class="form-control @error('nomor_wa') is-invalid @enderror" value="{{ old('nomor_wa') }}">
                            ...
                            <div class="row mt-4">
                                <div class="col-12 text-end">
                                    ...
                                    <button type="submit" class="btn text-white px-4" style="background-color: #EC1E88; border-radius: 8px;">Simpan Profil Suami</button>
                                </div>
                            </div>
                        </form>
                    </div>
