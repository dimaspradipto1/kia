                ...
                <div class="card-body p-4">
                    <form action="{{ route('roles.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nama_role" class="form-control @error('nama_role') is-invalid @enderror" value="{{ old('nama_role') }}" required placeholder="Contoh: Administrator, Nakes, dll">
                                @error('nama_role')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="3" placeholder="Penjelasan singkat mengenai kewenangan role ini">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
