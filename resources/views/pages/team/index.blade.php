            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="d-inline-flex shadow-sm overflow-hidden" style="border:1px solid #e3e6f0;border-radius:30px;">
                        <a href="{{ route('teams.create') }}" class="btn btn-success btn-sm font-weight-bold px-3 py-1 border-0"
                ...
                <div class="col-md-4 text-end">
                    <h5 class="m-0 fw-bold text-dark" style="font-size:1.1rem;">Manajemen Tim</h5>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).on('click', '.btn-delete', function (e) {
            ...
            Swal.fire({
                ...
                text: 'Data beserta foto akan dihapus permanen!',
                icon: 'warning',
